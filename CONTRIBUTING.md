# Contributing to restdouble

We'd love for you to contribute to our source code and to make restdouble even better than it is today! Here are the guidelines we'd like you to follow:
...
If you have questions about how to use the restdouble, please direct these to the [Slack group / philips-software][slack].
...
* **Restdouble Version(s)** - is it a regression?
...
In Github, send a pull request to original master branch: f.e. `restdouble:master`.
...
[github]: https://github.com/philips-software/restdouble/issues 
